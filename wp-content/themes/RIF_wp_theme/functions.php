...
/* candidati */
add_action('init', 'add_candidates');
function add_candidates() {
 
	$labels = array(
		'name' => _x('Candidati', 'post type general name'),
		'singular_name' => _x('Candidato', 'post type singular name'),
		'add_new' => _x('Nuovo Candidato', 'interes item'),
		'add_new_item' => __('Aggiungi Candidato'),
		'edit_item' => __('Modifica Candidato'),
		'new_item' => __('Nuovo Candidato'),
		'view_item' => __('Visualizza Candidato'),
		'search_items' => __('Cerca Candidato'),
	...
	register_post_type('candidati' , $args );
	//flush_rewrite_rules();
}
/**/
